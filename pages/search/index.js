...
Page({
   ...
   search:function(keyword)
  {
    ...
    /* request to server with keyword as query param */
     ...
     wx.request({
       url: 'https://api.pickabook.xyz/api/v1/posts/search?keyword=' + keyword,
       //url: 'http://202.182.124.93/api/v1/posts/search?keyword='+keyword,
     //  url: 'http://localhost:3002/api/v1/posts/search?keyword=' + keyword,
      method:'POST',
       header:{
       ...
       success: function (res) {
        ...
        if (res.data.code == 0) {
          ...
          console.log('search fail', res.data.code)
       }
      },
      complete:function()
      {
